...
class CustomShakingImage extends StatefulWidget {
  final String iconPath;
  final double height; // عشان لو عايزة تتحكمي في ارتفاعه من بره

  const CustomShakingImage({
    super.key,
  ...
  @override
  State<CustomShakingImage> createState() => _ShakingImageState();
}

class _ShakingImageState extends State<CustomShakingImage>
